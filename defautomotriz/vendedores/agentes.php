...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td width="645" valign="top">&nbsp;
	  <div align="center" class="Estilo1">
	    <div align="left">VENDEDORES DISPONIBLES </div>
	  </div>
...
$result = mysql_query("SELECT id_vend, nombre, apellido_p, apellido_m, Direccion FROM vendedor", $miconexion);
